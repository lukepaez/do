...
class Runs {
   ...
   * @returns
   */
  public modifyRun = async (thread_id: string, run_id: string, metadata?: object) => {
...
export const { createRun, retrieveRun, listRuns, cancelRun, createThreadRun, modifyRun } = new Runs();
