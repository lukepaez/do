...
class Assistants {
   ...
   * @returns
   */
  public createAssistant = async (instructions: string, name: string, tools: any[], model: string) => {
   ...
   * @returns
   */
  public listAssistants = async (limit?: number, order?: string, after?: string, before?: string) => {
